 ...
 export function UpgradePrompt({
   ...
   if (variant === 'banner') {
     return (
       <div
         className={cn(
           'p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-lg flex items-center justify-between gap-4',
           className
         )}
       >
   ...
   return (
     <Card className={cn('border-indigo-500/30 bg-indigo-500/5', className)}>
